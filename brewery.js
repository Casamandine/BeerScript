...
if(command.id){
    ...
    axios.get('https://sandbox-api.brewerydb.com/v2/brewery/'+arg+'/?key=0dc57b04be75a141664eb685134e5c7d')
        .then((response) => {
            ...
            return axios.get('https://sandbox-api.brewerydb.com/v2/brewery/'+arg+'/locations/?key=0dc57b04be75a141664eb685134e5c7d')
        })
        .then((response) => {
            breweries['Locality'] = response.locality
            breweries['Rergion'] = response.region
